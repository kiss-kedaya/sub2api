...
ROOT = Path('/opt/sub2api/rollout-332-20260919')
CONFIGS = {
...
STABLE_VERSION = '331'
STABLE_PORT = 8105
INITIAL_BACKUP_PORT = 8103
CANDIDATE_VERSION = '332'
CANDIDATE_PORT = 8107
...
def atomic_text(target, value):
    stage = target.with_name(target.name+'.332-tmp')
        ...
        with path.open() as stream:
            ...
            for line in stream:
                try:
                    ...
                    version = {'8095': '326', '8097': '326-grok600', '8103': '330', '8105': '331', '8107': '332'}[ports[-1]]
