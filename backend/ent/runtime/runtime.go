...
func init() {
	...
	paymentproviderinstanceDescCreatedAt := paymentproviderinstanceFields[12].Descriptor()
	...
	paymentproviderinstanceDescUpdatedAt := paymentproviderinstanceFields[13].Descriptor()
