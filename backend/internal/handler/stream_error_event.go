...
// Strict Responses clients require sequence_number even for a synthetic failure.
...
// A standalone gateway failure uses sequence 0 when no upstream sequence is available.
//
