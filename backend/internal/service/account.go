...
// openai/grok native OpenAI gateway; CN providers share Chat Completions.
// Gemini API Key with api_protocol uses the same OpenAI-compatible path.
...
// Gemini 自定义上游。
// MiniMax also supports native Responses; Zhipu does not.
