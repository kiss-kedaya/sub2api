export default {
    accounts: {
      ...
      testAllModelsProgress: 'Will test {total} models in order',
      testingModelProgress: '[{current}/{total}] {model}',
      testAllModelsFailed: '{failed}/{total} models failed',
      batchTest: {
        ...
        clearModels: 'Clear',
        noModels: 'No models to test',
        concurrency: 'Concurrency',
        includeMedia: 'Include media models',
        includeMediaHint: 'Skip image, video, and speech models by default',
        start: 'Start {accounts}×{models}={jobs}',
        startAll: 'Start {accounts} accounts, about {jobs} tests',
        jobCount: '{accounts}×{models}={jobs}',
        jobCountApprox: '{accounts} accounts, about {jobs} tests',
        stop: 'Stop',
        loadingCatalog: 'Loading model lists...',
        account: 'Account',
        model: 'Model',
        status: 'Status',
        duration: 'Time',
        ...
        failed: 'Failed',
        skipped: 'Skipped',
        summary: 'Success {success} · Failed {failed} · Running {running} · Queued {queued}',
        onlyFailed: 'Failed only',
        showAll: 'Show all',
        skippedMismatch: 'This account does not have that model',
        catalogFailed: 'Failed to load model list'
      },
      testing: 'Testing...',
      retry: 'Retry',
