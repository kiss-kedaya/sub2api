export default {
  ...
  payment: {
    ...
    tabRechargeCenter: 'Alipay / WeChat',
    rechargeCenterTitle: 'Alipay / WeChat',
    usdtExchangeAccounts: 'USDT exchange accounts',
    registerOkx: 'Register OKX',
    registerBinance: 'Register Binance',
    exchangeNetworkHint: 'Overseas network access required',
    ...
    rechargeCenterNetworkHint: 'Blank page or loading failure? Open it in a new tab. If it still fails, try another network.',
    rechargeCenterNetworkTitle: 'The checkout is not displaying correctly',
    rechargeCenterNetworkBody: 'Open the checkout in a new tab below to continue. If it still fails, try another network.',
