export default {
  ...
  payment: {
    ...
    tabTopUp: '充值',
    tabSubscribe: '充值中心',
    tabRechargeCenter: '支付宝 / 微信',
    rechargeCenterTitle: '支付宝 / 微信',
    usdtExchangeAccounts: 'USDT 交易所账户',
    registerOkx: '注册 OKX',
    registerBinance: '注册 Binance',
    exchangeNetworkHint: '需海外网络环境访问',
    ...
    rechargeCenterNetworkHint: '页面空白或加载失败？点击「新窗口打开」，仍无法打开请更换网络后重试。',
    rechargeCenterNetworkTitle: '收银台暂未正常显示',
    rechargeCenterNetworkBody: '请点击下方「新窗口打开」继续支付；若仍无法打开，请更换网络后重试。',
    noPlans: '暂无可用订阅套餐',
