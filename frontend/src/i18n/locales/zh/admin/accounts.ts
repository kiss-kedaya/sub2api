export default {
    accounts: {
      ...
      testAllModelsProgress: '将按顺序测试 {total} 个模型',
      testingModelProgress: '[{current}/{total}] {model}',
      testAllModelsFailed: '{failed}/{total} 个模型失败',
      batchTest: {
        title: '批量检测模型',
        ...
        concurrency: '并发',
        includeMedia: '包含媒体模型',
        includeMediaHint: '默认跳过生图、视频、语音等耗时长的模型',
        start: '开始 {accounts}×{models}={jobs}',
        startAll: '开始 {accounts} 个账号，约 {jobs} 次',
        jobCount: '{accounts}×{models}={jobs} 次',
        jobCountApprox: '{accounts} 个账号，约 {jobs} 次',
        stop: '停止',
        loadingCatalog: '正在读取模型列表...',
        account: '账号',
        model: '模型',
        status: '状态',
        duration: '耗时',
        ...
        failed: '失败',
        skipped: '跳过',
        summary: '成功 {success} · 失败 {failed} · 进行中 {running} · 排队 {queued}',
        onlyFailed: '只看失败',
        showAll: '查看全部',
        skippedMismatch: '该账号没有这个模型',
        catalogFailed: '读取模型列表失败'
      },
      retry: '重试',
      copyOutput: '复制输出',
      outputCopied: '输出已复制',
